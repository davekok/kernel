...
class StreamKernelFactory
{
    ...
    /**
     * Implement the TimeOutInterface if you would like to add cron like abilities to the stream server.
     *
     ...
     *         ->run();
     */
    public function createServerKernel(TimeOutInterface|null $timeOut = null): StreamServerKernel
    {
